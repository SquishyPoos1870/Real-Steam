...
local function entity_fluidbox(entity)
...
local function entity_has_fluidbox(entity)
  local fluidbox = entity_fluidbox(entity)
  return fluidbox ~= nil and #fluidbox > 0
end
...
local function steam_entity_should_emit(entity)
  ...
  if entity_has_fluidbox(entity) then
